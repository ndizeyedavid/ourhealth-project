  ...
  return (
    <>
     <div className="absolute bottom-2 w-full p-2 h-[80px]">
        ...
        <div className="flex items-center justify-between w-full h-full gap-3 p-2 rounded-full" style={{background: "#2f2f2f"}}>
            <button className="btn btn-circle btn-outline btn-ghost">
            ...
            <textarea className="w-full h-full pt-2.5 text-xl" placeholder="Describe how you feel" style={{background: "none", outline: "none", overflow: "hidden", resize: "none"}}></textarea>

            <button className="bg-white btn btn-circle btn-outline btn-ghost">
